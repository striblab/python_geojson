...
def sheet_to_json(obj, file_name):
    '''
...
sheet_to_json(now_open_json, './now_open.geojson')
sheet_to_json(announced_json, './announced.geojson')
sheet_to_json(closing_changing_json, './closing_changing.geojson')
